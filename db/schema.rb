...
ActiveRecord::Schema.define(version: 20140719174844) do

  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"

  create_table "followedposts", force: true do |t|
    t.integer  "post_id"
    t.integer  "user_id"
  ...
  add_index "followedposts", ["post_id"], name: "index_followedposts_on_post_id", using: :btree
  add_index "followedposts", ["user_id"], name: "index_followedposts_on_user_id", using: :btree
  ...
  add_index "sumpoints", ["user_id"], name: "index_sumpoints_on_user_id", using: :btree
  ...
  create_table "users", force: true do |t|
    ...
    t.datetime "updated_at"
    t.string   "role"
    t.boolean  "email_followed",         default: false
  end
